...
//disable beberapa keyboard kombinasi ctrl+
document.onkeydown=function(e)
{
if(e.which == 17)
isCtrl=true;
if((event.which == 118 || event.which == 86 || e.which == 85 || e.which == 87 || e.which == 117 || e.which == 65 || e.which == 97 || e.which == 67 || e.which == 99) && isCtrl == true)
{
return false;
}
}
